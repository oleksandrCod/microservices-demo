...
public class OrderController {
    ...
    public CompletableFuture<String> placeOrderFallbackMethod(
            OrderRequestDto orderRequestDto, RuntimeException exception) {
        return CompletableFuture.supplyAsync(() -> "Ops! Something went wrong");
    }
}
